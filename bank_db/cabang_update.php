...
$cabang = query("SELECT * FROM cabang WHERE kodeCabang = $kodeCabang")[0];
        ...
        <div class="row my-2">
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        <input type="hidden" name="kodeCabang" value="<?= $cabang["kodeCabang"];?>"> 
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control w-50" row="5" id="alamatCabang" placeholder="Masukkan Alamat"
                            name="alamatCabang" required value="<?= $cabang["alamatCabang"];?>">
                    </div>
                    <div class="mb-3">
